<html lang="en"><head>
  ...
  <body onselectstart="return false" oncontextmenu="return false">
   <ul id="header">
      <li><a href="index.jsp">Terrain1</a></li>
      ...
      <label for="opacity">Opacity: </label><input type="range" id="opacity"><label for="color" style="margin-left: 10px;">Color: </label><input type="color" id="color" style="width: 40px;"></div>
      <div style="position:relative;width:550px;float:left;">
        <div id="fps" style="display:none;">&nbsp;</div>
        <div class="canvas-container" style="width: 546px; height: 350px; position: relative; -webkit-user-select: none;"><canvas class="lower-canvas" width="546" height="350" style="position: absolute; width: 546px; height: 350px; left: 0px; top: 0px; -webkit-user-select: none;"></canvas><canvas id="canvas" width="546" height="350" class="upper-canvas" style="position: absolute; width: 546px; height: 350px; left: 0px; top: 0px; -webkit-user-select: none; cursor: default;"></canvas></div>
      ...
      <div id="commands">
       <ul>
        ...
        <!-- rouge -->
            ...
            <input type="image" src="img/players/pos4_rouge_corde.png" class="pos4_rouge_corde" width="40" height="40">
            ...
            <input type="image" src="img/players/pos10_bleu.png" class="pos10_bleu" width="40" height="40">
             <input type="image" src="img/players/pos4_bleu_corde.png" class="pos4_bleu_corde" width="40" height="40">
            ...
            <input type="image" src="img/players/pos4_orange_corde.png" class="pos4_orange_corde" width="40" height="40">
            ...
            <input type="image" src="img/players/pos10_vert.png" class="pos10_vert" width="40" height="40">
             <input type="image" src="img/players/pos4_vert_corde.png" class="pos4_vert_corde" width="40" height="40">
            ...
            <input type="image" src="img/players/pos10_violet.png" class="pos10_violet" width="40" height="40">
             <input type="image" src="img/players/pos4_violet_corde.png" class="pos4_violet_corde" width="40" height="40">
            ...
            <input type="image" src="img/fleches/fleche2.png" class="fleche2" width="30" height="10">
             ...
             <input type="image" src="img/fleches/fleche2_r.png" class="fleche2_r" width="30" height="10">
              ...
              <input type="image" src="img/fleches/fleche2_bl.png" class="fleche2_bl" style="border:1px solid #999;" width="30" height="10"> 
               ...
               <input type="image" src="img/fleches/point1_bl.png" class="point1_bl" style="border:1px solid #999;" width="40" height="20"> 
               ...
               <input type="image" src="img/fleches/zig1_bl.png" class="zig1_bl" style="border:1px solid #999;" width="40" height="40">
               ...
               <!-- <input type="image" src="img/fleches/zig2.png" class="zig2" width="40" height="40" ></input>  -->
                ...
                <!-- <input type="image" src="img/haies/haie1.png" class="haie1" width="40" height="40" ></input>-->
                  ...
                  <input type="image" src="img/cerceaux/cerceau_b.png" class="cerceau_b" width="40" height="40">
                     <input type="image" src="img/cerceaux/cerceau_bl.png" class="cerceau_bl" style="border:1px solid #999;" width="40" height="40">
                    ...
                    <input type="image" src="img/cages/cage_bl_1_btn.png" class="cage_bl_1" width="25" height="25">
                     <input type="image" src="img/cages/cage_bl_2_btn.png" class="cage_bl_2" width="25" height="25">
                      <input type="image" src="img/cages/cage_bl_3_btn.png" class="cage_bl_3" width="25" height="25">
                       <input type="image" src="img/cages/cage_bl_4_btn.png" class="cage_bl_4" width="25" height="25">         			<input type="image" src="img/echelles/echelle.png" class="echelle" width="25" height="25">
                 ...
                 <input type="image" src="img/fleches/retour_b_rtl.png" class="retour_b_rtl" width="25" height="25">
                  <input type="image" src="img/fleches/retour_point_r_rtl.png" class="retour_point_r_rtl" width="25" height="25"> 
                 <input type="image" src="img/fleches/retour_point_b_rtl.png" class="retour_point_b_rtl" width="25" height="25">
